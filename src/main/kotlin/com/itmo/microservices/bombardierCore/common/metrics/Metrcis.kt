package com.itmo.microservices.bombardierCore.common.metrics
...
import com.itmo.microservices.bombardierCore.bombardier.stages.TestStage
...
class Metrics {
    ...
    fun withTags(vararg tags: String): com.itmo.microservices.bombardierCore.common.metrics.Metrics {
        var m = com.itmo.microservices.bombardierCore.common.metrics.Metrics()
